...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/intent.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/signature-scheme.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/publickey.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/keypairs/passkey/publickey.js
...
var PasskeyPublicKey = class extends PublicKey {
  ...
  async verify(message, signature) {
    ...
    return secp256r12.verify(sig, sha2562(payload), pk);
  }
};
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/graphql/generated/queries.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/experimental/transports/graphql.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/graphql/client.js
var _url;
var _queries;
var _headers;
var _fetch;
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/jwt-decode.js
var InvalidTokenError = class extends Error {
};
InvalidTokenError.prototype.name = "InvalidTokenError";

// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/poseidon.js
var import_poseidon_lite = __toESM(require_poseidon_lite(), 1);

// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/utils.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/bcs.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/zklogin/publickey.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/signature.js
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/cryptography/keypair.js
var Signer = class {
  /**
...
// node_modules/.pnpm/@mysten+sui@1.29.1_typescript@5.7.3/node_modules/@mysten/sui/dist/esm/keypairs/passkey/keypair.js
var __typeError3 = (msg) => {
  throw TypeError(msg);
};
var __accessCheck3 = (obj, member, msg) => member.has(obj) || __typeError3("Cannot " + msg);
var __privateGet3 = (obj, member, getter) => (__accessCheck3(obj, member, "read from private field"), getter ? getter.call(obj) : member.get(obj));
var __privateAdd = (obj, member, value) => member.has(obj) ? __typeError3("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
var BrowserPasskeyProvider = class {
  ...
  async create() {
    return await navigator.credentials.create({
      publicKey: {
        timeout: __privateGet3(this, _options).timeout ?? 6e4,
        ...__privateGet3(this, _options),
        rp: {
          name: __privateGet3(this, _name),
          ...__privateGet3(this, _options).rp
        },
        user: {
          name: __privateGet3(this, _name),
          displayName: __privateGet3(this, _name),
          ...__privateGet3(this, _options).user,
          id: randomBytes(10)
        },
        ...
        authenticatorSelection: {
          ...
          ...__privateGet3(this, _options).authenticatorSelection
        }
      }
    });
  }
  async get(challenge) {
    ...
    return await navigator.credentials.get({
      publicKey: {
        challenge,
        userVerification: ((_a = __privateGet3(this, _options).authenticatorSelection) == null ? void 0 : _a.userVerification) || "required",
        timeout: __privateGet3(this, _options).timeout ?? 6e4
      }
    });
  }
...
var PasskeyKeypair = class _PasskeyKeypair extends Signer {
  /**
  ...
  static async getPasskeyInstance(provider) {
    ...
    if (!credential.response.getPublicKey()) {
      ...
      const pubkey = secp256r12.ProjectivePoint.fromHex(pubkeyUncompressed);
      const pubkeyCompressed = pubkey.toRawBytes(true);
      return new _PasskeyKeypair(pubkeyCompressed, provider);
    }
  }
  /**
  ...
  async sign(data) {
    ...
    const sig = secp256r12.Signature.fromDER(new Uint8Array(credential.response.signature));
  ...
  static async signAndRecover(provider, message) {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      try {
        const pubkey = s.recoverPublicKey(sha2562(fullMessage));
...
function messageFromAssertionResponse(response) {
  ...
  const clientDataJSONDigest = sha2562(clientDataJSON);
...
*/
//# sourceMappingURL=@mysten_sui_keypairs_passkey.js.map
